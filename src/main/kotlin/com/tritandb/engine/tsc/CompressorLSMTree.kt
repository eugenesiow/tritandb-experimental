...
//    val MAX_BYTES = 1048576
    ...
    private val map = com.tritandb.engine.experimental.lsm.StoreBuilder(File(fileName), LongSerializer(), ByteArraySerializer()).setCodec(null).setBlockSize(MAX_BYTES.toLong()*2).setStorageType(com.tritandb.engine.experimental.lsm.StorageType.INLINE).build()
