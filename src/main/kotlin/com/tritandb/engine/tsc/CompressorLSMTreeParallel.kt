...
class CompressorLSMTreeParallel (fileName:String, val columns:Int, val name:String, chunkSize:Int):Compressor {
    ...
    private val map = com.tritandb.engine.experimental.lsm.StoreBuilder(File(fileName), LongSerializer(), ByteArraySerializer()).setCodec(null).setStorageType(com.tritandb.engine.experimental.lsm.StorageType.INLINE).build()
